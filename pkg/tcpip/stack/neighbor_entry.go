...
func (e *neighborEntry) setStateLocked(next NeighborState) {
	...
	case Incomplete:
		...
		sendMulticastProbe = func() {
			...
			retryCounter++
			e.cancel = e.nic.stack.clock.AfterFunc(&e.mu, config.RetransmitTimer, sendMulticastProbe)
		}
	...
	case Probe:
		...
		sendUnicastProbe = func() {
			...
			e.cancel = e.nic.stack.clock.AfterFunc(&e.mu, config.RetransmitTimer, sendUnicastProbe)
		}
