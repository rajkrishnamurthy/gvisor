...
const (
	...
	MinBufferSize = 4 << 10 // 4Kib

	// DefaultSendBufferSize is the default size of the send buffer for
	// a transport endpoint.
	DefaultSendBufferSize = 212 << 10 // 212 Kib

	// MaxSendBufferSize is the maximum permitted size of a send/receive buffer.
	MaxSendBufferSize = 4 << 20 // 4 Mib

	// DefaultReceiveBufferSize is the default size of the receive buffer.
	DefaultReceiveBufferSize = 212 << 10 // 212 Kib

	// MaxReceiveBufferSize is the maximum permitted size of the receive
	// buffer.
	MaxReceiveBufferSize = 4 << 20 // 4 Mib
)
